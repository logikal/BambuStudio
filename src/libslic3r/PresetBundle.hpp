...
public:
    ...
    std::string           get_print_alias_for_preset(const std::string &preset_name) const;
    std::vector<std::string> get_print_preset_names_by_alias_for_current_printer(const std::string &alias, bool compatible_only = true) const;
    std::string           get_print_preset_nozzle_label(const std::string &preset_name) const;
    std::string           get_print_preset_name_by_alias_for_filament(const std::string &alias,
                                                                      size_t filament_idx,
                                                                      const std::vector<int> &filament_maps,
                                                                      const std::vector<double> *nozzle_diameters_override = nullptr,
                                                                      bool compatible_only = true) const;
    bool                  print_preset_matches_slot_nozzle(const std::string &preset_name,
                                                           size_t filament_idx,
                                                           const std::vector<int> &filament_maps,
                                                           const std::vector<double> *nozzle_diameters_override = nullptr) const;
